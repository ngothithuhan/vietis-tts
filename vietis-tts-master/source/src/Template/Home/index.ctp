		...
		<div class="swiper-container">
		    <div class="swiper-wrapper">
		      <div class="swiper-slide">
		      	<div class=" item">
		      		<?= $this->HTML->image('home/day-chuyen-1.jpg'); ?>
		      		<h3>VINTAGE RINGS</h3>
		      		<p>398,000 đ</p>
		      		<a href="" class="button btn btn-danger">THÊM VÀO GIỞ</a>
		      	</div>
		      </div>
		      <div class="swiper-slide">
		      	<div class=" item">
		      		<?= $this->HTML->image('home/earring-1.jpg'); ?>
		      		<h3>personalized Infinity...</h3>
		      		<p>398,000 đ</p>
		      		<a href="" class="button btn btn-danger">THÊM VÀO GIỞ</a>
		      	</div>
		      </div>
		      <div class="swiper-slide">
		      	<div class=" item">
		      		<?= $this->HTML->image('home/ring-1.jpg'); ?>
		      		<h3>STACKABLE EARRING</h3>
		      		<p>398,000 đ</p>
		      		<a href="" class="button btn btn-danger">THÊM VÀO GIỞ</a>
		      	</div>
		      </div>
		      <div class="swiper-slide">
		      	<div class=" item">
		      		<?= $this->HTML->image('home/ring-2.jpg'); ?>
		      		<h3>pRINTED DEFAULT</h3>
		      		<p>398,000 đ</p>
		      		<a href="" class="button btn btn-danger">THÊM VÀO GIỞ</a>
		      	</div>
		      </div>
		      <div class="swiper-slide">
		      	<div class=" item">
		      		<?= $this->HTML->image('home/earring-2.jpg'); ?>
		      		<h3>Necklace witd Intial ...</h3>
		      		<p>398,000 đ</p>
		      		<a href="" class="button btn btn-danger">THÊM VÀO GIỞ</a>
		      	</div>
		      </div>
		      <div class="swiper-slide">
		      	<div class=" item">
		      		<?= $this->HTML->image('home/earring-3.jpg'); ?>
		      		<h3>SLIVER EARRINGS</h3>
		      		<p>398,000 đ</p>
		      		<a href="" class="button btn btn-danger">THÊM VÀO GIỞ</a>
		      	</div>
		      </div>
		      <div class="swiper-slide">
		      	<div class=" item">
		      		<?= $this->HTML->image('home/ring-3.jpg'); ?>
		      		<h3>DRAGONFLY JEWELRY</h3>
		      		<p>398,000 đ</p>
		      		<a href="" class="button btn btn-danger">THÊM VÀO GIỞ</a>
		      	</div>
		      </div>
		      <div class="swiper-slide">
		      	<div class=" item">
		      		<?= $this->HTML->image('home/earring-4.jpg'); ?>
		      		<h3>AZROUEL VARIABLE</h3>
		      		<p>398,000 đ</p>
		      		<a href="" class="button btn btn-danger">THÊM VÀO GIỞ</a>
		      	</div>
		      </div>
		      <div class="swiper-slide">
		      	<div class=" item">
		      		<?= $this->HTML->image('home/ring-5.jpg'); ?>
		      		<h3>SLEEVE EXTERNAL</h3>
		      		<p>398,000 đ</p>
		      		<a href="" class="button btn btn-danger">THÊM VÀO GIỞ</a>
		      	</div>
		      </div>
	...
	<div class="holder">
		<div class="swiper-container">
		    <div class="swiper-wrapper">
		      ...
		      <div class="swiper-slide">
		      	<div class=" item">
		      		<?= $this->HTML->image('home/ring-4.jpg'); ?>
		      		<h3>SLEEVE EXTERNAL</h3>
		      		<p>398,000 đ</p>
		      		<a href="" class="button btn btn-danger">THÊM VÀO GIỞ</a>
		      	</div>
